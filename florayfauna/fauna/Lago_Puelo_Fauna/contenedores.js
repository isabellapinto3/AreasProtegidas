class Contenedores {
  ...
  completarVariables(){
    ...
    this.info = loadImage("img/info.png");
    this.Atitulo = "Zorzal Patagonico";
    this.AdescripcionLinea1= "Es el ave más vista en el bosque y el entorno de la Patagonia andina a lo";
    this.AdescripcionLinea2= "largo del año, incluso en zonas pobladas, donde suele ser abundante";
    ...
    this.AtituloBoton1 = "Plumas";
    this.AdescripcionBoton1Linea1 = "El plumaje no es muy colorido, pero el pico";
    this.AdescripcionBoton1Linea2 = "amarillo brillante a menudo es llamativo.";
    this.AdescripcionBoton1Linea3 = "El macho tiene la cabeza más negra y las";
    this.AdescripcionBoton1Linea4 = "partes superiores.";
    this.AdescripcionBoton1Linea5 = "";
    this.AdescripcionBoton1Linea6 = "";
    this.AimgBoton2 = loadImage("img/AimgBoton2.jpg");
    this.AtituloBoton2 = "Alimentacion";
    this.AdescripcionBoton2Linea1 = "Comen lombrices, caracoles u otros";
    this.AdescripcionBoton2Linea2 = "animales de cuerpo blando y frutos";
    this.AdescripcionBoton2Linea3 = "maduros. Se reproducen entre ";
    this.AdescripcionBoton2Linea4 = "septiembre y octubre.";
    ...
    this.info2 = loadImage("img/info2.png");
    this.Btitulo = "Huemul";
    ...
    this.BdescripcionLinea3= "habita en la cordillera de los Andes";
    ...
    this.BdescripcionBoton1Linea1 = "Se encuentra categorizada como especie ";
    this.BdescripcionBoton1Linea2 = "en peligro de extinción, debido principalmente";
    this.BdescripcionBoton1Linea3 = "a la caza mayor";
    ...
    this.info3 = loadImage("img/info3.png");
    this.Ctitulo = "Coipo";
    this.CdescripcionLinea1= "Especie ampliamente distribuida y abundante. Fue muy explotada";
    this.CdescripcionLinea2= "por el valor comercial de su piel y actualmente se la sigue cazando;";
    this.CdescripcionLinea3= "sin embargo sus poblaciones no se ven afectadas debido a su alta";
    this.CdescripcionLinea4= "tasa de reproducción y su gran capacidad de adaptación.";
    ...
    this.CdescripcionBoton1Linea1 = "Tiene una interesante adaptación a la vida";
    this.CdescripcionBoton1Linea2 = "acuática que consiste en la posición de";
    this.CdescripcionBoton1Linea3 = "sus mamas, colocadas a lo largo de ambos";
    this.CdescripcionBoton1Linea4 = "lados, en el dorso";
    this.CdescripcionBoton1Linea5 = "";
    this.CdescripcionBoton1Linea6 = "";
    this.CimgBoton2 = loadImage("img/CimgBoton2.jpg");
    this.CtituloBoton2 = "Ocio";
    this.CdescripcionBoton2Linea1 = "Los avellanos son arboles principalmente utilizados";
    this.CdescripcionBoton2Linea2 = "por la gran sombra que proveen sus frondosas";
    this.CdescripcionBoton2Linea3 = "copas";
  ...
  dibujar() {
    ...
    if (this.contenedorA && !this.animacion) {
      ...
      push();
      imageMode (CORNERS);
      image(this.info,width / 19, height / 1.48, this.gpx1, windowHeight-alto/15);
      pop();
      pop();

    }
    if (this.contenedorB && !this.animacion) {
      //---------------------------- IMAGEN 2 INFOGRAFIA ESTADISTICA 671x248px
      //contenedor 1
      fill(90, 255, 90);
      ...
      //this.boton2(width / 20, height / 2.15, this.Br, this.Bg, this.Bb, this.BimgBoton2); //----------------2 BOTON 2 ELEMENTO
      if(this.botActivo2){
      //
      ...
      push();
      imageMode (CORNERS);
      image(this.info2,width / 19, height / 1.48, this.gpx1, windowHeight-alto/15);
      pop();
      pop();
    ...
    if (this.contenedorC && !this.animacion) {
      ...
      //this.boton2(width / 20, height / 2.15, this.Cr, this.Cg, this.Cb, this.CimgBoton2);    //2 BOTON 3 ELEMENTO---------------------
      if(this.botActivo2){
      //
      ...
      push();
      imageMode (CORNERS);
      image(this.info3,width / 19, height / 1.48, this.gpx1, windowHeight-alto/15);
      pop();
      pop();
