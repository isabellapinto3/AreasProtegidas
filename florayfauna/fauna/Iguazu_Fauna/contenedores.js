class Contenedores {
  ...
  completarVariables(){
    ...
    this.Atitulo = "Vencejo de cascada";
    this.AdescripcionLinea1= "Es el ave emblema del parque Iguazu, pasa casi el 100% de su vida en el aire";
    this.AdescripcionLinea2= "alimentándose mientras vuela e inclusive durante el apareamiento.";
    ...
    this.AtituloBoton1 = "Nidos";
    this.AdescripcionBoton1Linea1 = "Construye los nidos detrás de los saltos, ";
    this.AdescripcionBoton1Linea2 = "posee unas patas muy cortas las cuales ";
    this.AdescripcionBoton1Linea3 = "se adaptan para adherirse a las rocas ";
    this.AdescripcionBoton1Linea4 = "mojadas";
    ...
    this.Btitulo = "Coatíes";
    this.BdescripcionLinea1= "Es uno de los animales más simbólicos de la Provincia de ";
    this.BdescripcionLinea2= "Misiones. Es un omnívoro plantígrado de la familia del ";
    this.BdescripcionLinea3= "mapache. Viven en grupos de 10 a 20 individuos y se ";
    this.BdescripcionLinea4= "caracterizan por ser muy curiosos con el medio que los rodea.";
    ...
    this.BtituloBoton1 = "Pequeños Curiosos";
    this.BdescripcionBoton1Linea1 = "Si bien parecen amigables, los coatíes ";
    this.BdescripcionBoton1Linea2 = "puedenrasguñar o incluso robar objetos  ";
    this.BdescripcionBoton1Linea3 = "de los turistas.";
  ...
  // grafico
    ...
    this.Ctitulo = "Tucan";
    this.CdescripcionLinea1= "Sus bordes aserrados facilitan la aprehensión de alimentos. Si bien la ";
    this.CdescripcionLinea2= "mayoría son frugívoras, complementan su dieta con invertebrados, ";
    this.CdescripcionLinea3= "huevos y pichones de otras aves. Todas las especies anidan en";
    this.CdescripcionLinea4= "huecos de árboles, donde ponen huevos claros sin manchas.";
    ...
    this.CtituloBoton1 = "Fisonomia";
    this.CdescripcionBoton1Linea1 = "El pico enorme, y en general bien colorido, ";
    this.CdescripcionBoton1Linea2 = "las hacen inconfundibles. Pese al ";
    this.CdescripcionBoton1Linea3 = "tamaño, su pico es bien liviano. ";
