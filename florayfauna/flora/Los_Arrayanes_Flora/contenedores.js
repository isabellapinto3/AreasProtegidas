class Contenedores {
  ...
  completarVariables(){
    ...
    this.AdescripcionLinea1= "Es una especie del género Salix nativa de América, desde México hasta el ";
    this.AdescripcionLinea2= "norte de la provincia argentina de Santa Cruz. Su uso cotidiano aplica a la ";
    ...
    this.AdescripcionBoton1Linea2 = "por su liviandad, tenacidad y por no transmitir";
    this.AdescripcionBoton1Linea3 = "olor, propiedades importantes para la ";
    this.AdescripcionBoton1Linea4 = "fabricación de cajones destinados a la";
    this.AdescripcionBoton1Linea5 = "industria frutícola.";
    ...
    this.BdescripcionLinea2= "reducir la sensación de pesadez en las piernas, ya ";
    this.BdescripcionLinea3= "que posee efectos sobre la circulación sanguínea.";
    ...
    this.Ctitulo = "Ñire";
    this.CdescripcionLinea1= "Es uno de los grandes árboles del género Nothofagus, en Argentina son ";
    this.CdescripcionLinea2= "endemicos de la zona del Bosque Húmedo, donde tambien hay otros arboles ";
    this.CdescripcionLinea3= "cómo los coihues y lenguas. ";
    ...
    this.CtituloBoton1 = "Su madera";
    this.CdescripcionBoton1Linea1 = "Anteriormente fue utilizada cómo leña por su ";
    this.CdescripcionBoton1Linea2 = "resistencia y larga duracíon, actualmente se";
    this.CdescripcionBoton1Linea3 = "utiliza para producir manofacturas cómo ";
    this.CdescripcionBoton1Linea4 = "muebles.";
