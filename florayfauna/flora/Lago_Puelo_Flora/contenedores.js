class Contenedores {
  ...
  completarVariables() {
    ...
    this.Atitulo = "Rosa Mosqueta";
    this.AdescripcionLinea1 =
      "La rosa mosqueta es una planta exótica invasora que se diseminó en";
    this.AdescripcionLinea2 =
      "varios sectores de la región. Su fruto silvestre, también conocido como";
    this.AdescripcionLinea3 = "escaramujo.";
    ...
    this.AdescripcionBoton2Linea1 =
      "El aceite extraído de sus semillas se aprovecha";
    ...
    this.Btitulo = "Pitra";
    this.BdescripcionLinea1 =
      "Árbol pequeño de corteza rugosa, hojas grandes y flores blancas";
    this.BdescripcionLinea2 = "";
    ...
    this.BtituloBoton1 = "Baños relajantes";
    this.BdescripcionBoton1Linea1 = "Se usaba las hojas en baños para dolores ";
    this.BdescripcionBoton1Linea2 = "reumáticos porque son estimulantes y";
    this.BdescripcionBoton1Linea3 = "astringentes";
    ...
    this.BdescripcionBoton2Linea1 =
      "El aceite extraído de sus semillas hojas sirve";
    this.BdescripcionBoton2Linea2 =
      "como calmante para las reacciones cutaneas";
    ...
    this.Ctitulo = "Avellano";
    this.CdescripcionLinea1 =
      "Árbol pequeño de corteza rugosa, hojas grandes y flores blancas";
    ...
    this.CtituloBoton1 = "Su fruto";
    this.CdescripcionBoton1Linea1 =
      "La avellana se compone hasta un 65% de aceite,";
    this.CdescripcionBoton1Linea2 =
      "es uno de los frutos secos más nutritivos y";
    this.CdescripcionBoton1Linea3 =
      "remineralizantes. Tiene aceites y alcoholes";
    this.CdescripcionBoton1Linea4 = "pueden usarse para detener hemorragias";
    ...
    this.CdescripcionBoton2Linea1 =
      "Los avellanos son arboles principalmente utilizados";
    this.CdescripcionBoton2Linea2 =
      "por la gran sombra que proveen sus frondosas";
  ...
  dibujar() {
    ...
    if (this.contenedorA && !this.animacion) {
      // ### CONTEDOR A CONTEDOR A CONTEDOR A CONTEDOR A CONTEDOR A CONTEDOR A ###
      //
      ...
      fill(90, 90, 255);
      image(
        this.CimgContenedorCut,
        width / 2.5 + width / 2.8 + width / 8,
        0,
        width / 8,
        height
      );
    ...
    if (this.contenedorB && !this.animacion) {
      // ### CONTEDOR B CONTEDOR B CONTEDOR B CONTEDOR B CONTEDOR B CONTEDOR B ###
      //contenedor 1
      fill(90, 255, 90);
    ...
    if (this.contenedorC && !this.animacion) {
      // ### CONTEDOR C CONTEDOR C CONTEDOR C CONTEDOR C CONTEDOR C CONTEDOR C ###
      //contenedor 1
      fill(90, 90, 255);
  ...
  boton(x, y, colR, colG, colB, img) {
    ...
    if (!this.botActivo) {
      ...
      if (this.contenedorA) {
        ...
        text(
          this.AtituloBoton1,
          this.cardpx + windowHeight / 5,
          this.cardpy + windowHeight / 25
        );
        pop();
        fill(0);
        textSize(windowHeight / 52.5);
        text(
          this.AdescripcionBoton1Linea1,
          this.cardpx + windowHeight / 5,
          this.cardpy + windowHeight / 14.3
        );
        text(
          this.AdescripcionBoton1Linea2,
          this.cardpx + windowHeight / 5,
          this.cardpy + windowHeight / 11.1
        );
        text(
          this.AdescripcionBoton1Linea3,
          this.cardpx + windowHeight / 5,
          this.cardpy + windowHeight / 9.1
        );
        text(
          this.AdescripcionBoton1Linea4,
          this.cardpx + windowHeight / 5,
          this.cardpy + windowHeight / 7.7
        );
        text(
          this.AdescripcionBoton1Linea5,
          this.cardpx + windowHeight / 5,
          this.cardpy + windowHeight / 6.77
        );
        text(
          this.AdescripcionBoton1Linea6,
          this.cardpx + windowHeight / 5,
          this.cardpy + windowHeight / 6
        );
      }
      if (this.contenedorB) {
        noStroke();
        ...
        textSize(windowHeight / 52.5);
        text(
          this.BdescripcionBoton1Linea1,
          this.cardpx + windowHeight / 5,
          this.cardpy + windowHeight / 14.3
        );
        text(
          this.BdescripcionBoton1Linea2,
          this.cardpx + windowHeight / 5,
          this.cardpy + windowHeight / 11.1
        );
        text(
  ...
  boton2(x, y, colR, colG, colB, img) {
    ...
    if (!this.botActivo2) {
      ...
      if (this.contenedorA) {
        ...
        text(
          this.AtituloBoton2,
          this.cardpx2 + windowHeight / 5,
          this.cardpy2 + windowHeight / 25
        );
        pop();
        fill(0);
        textSize(windowHeight / 52.5);
        text(
          this.AdescripcionBoton2Linea1,
          this.cardpx2 + windowHeight / 5,
          this.cardpy2 + windowHeight / 14.3
        );
        text(
          this.AdescripcionBoton2Linea2,
          this.cardpx2 + windowHeight / 5,
          this.cardpy2 + windowHeight / 11.1
        );
        text(
          this.AdescripcionBoton2Linea3,
          this.cardpx2 + windowHeight / 5,
          this.cardpy2 + windowHeight / 9.1
        );
        text(
          this.AdescripcionBoton2Linea4,
          this.cardpx2 + windowHeight / 5,
          this.cardpy2 + windowHeight / 7.7
        );
        text(
          this.AdescripcionBoton2Linea5,
          this.cardpx2 + windowHeight / 5,
          this.cardpy2 + windowHeight / 6.77
        );
        text(
          this.AdescripcionBoton2Linea6,
          this.cardpx2 + windowHeight / 5,
          this.cardpy2 + windowHeight / 6
        );
      }
      if (this.contenedorB) {
        noStroke();
