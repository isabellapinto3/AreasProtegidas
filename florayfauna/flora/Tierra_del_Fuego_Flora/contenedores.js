class Contenedores {
  ...
  completarVariables(){
    ...
    this.Atitulo = "Ciruelillo";
    this.AdescripcionLinea1= "En cuanto a la vegetación y flora, la mayoría del Parque nacional Tierra del ";
    this.AdescripcionLinea2= "Fuego está constituido por bosque andino, bosque magallánico y bosque";
    this.AdescripcionLinea3= "pre-antártico.";
    ...
    this.AtituloBoton1 = "Madera";
    this.AdescripcionBoton1Linea1 = "La madera es muy apreciada por su belleza";
    this.AdescripcionBoton1Linea2 = "y porque es fácil de trabajar.";
    ...
    this.AtituloBoton2 = "Madera";
    this.AdescripcionBoton2Linea1 = "La corteza es utilizada en medicina popular ";
    this.AdescripcionBoton2Linea2 = "para aliviar dolores de muela y sus flores ";
    this.AdescripcionBoton2Linea3 = "maceradas como cicatrizante";
    ...
    this.Btitulo = "Canelo";
    this.BdescripcionLinea1= "El canelo es un árbol de tronco grisáceo poco ramificado que puede alcanzar ";
    this.BdescripcionLinea2= "unos 20 m de altura. Corteza. Su corteza se ha usado para combatir el ";
    this.BdescripcionLinea3= "escorbuto";
    ...
    this.BtituloBoton1 = "Hojas";
    this.BdescripcionBoton1Linea1 = "Se utiliza la hoja en infusión y la corteza  ";
    this.BdescripcionBoton1Linea2 = "en cocimiento para tratar diversas";
    this.BdescripcionBoton1Linea3 = "afecciones. Se toma el infuso para combatir";
    this.BdescripcionBoton1Linea4 = "tos y catarros";
    ...
    this.Ctitulo = "Coihue magallánico";
    this.CdescripcionLinea1= "Crece endémicamente en el bosque andino patagónico del sur de Chile y de ";
    this.CdescripcionLinea2= "Argentina";
