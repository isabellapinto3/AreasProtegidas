class Contenedores {
  ...
  completarVariables(){
    ...
    this.Atitulo = "Ñire";
    this.AdescripcionLinea1= "Es uno de los grandes árboles del género Nothofagus, en Argentina son ";
    this.AdescripcionLinea2= "endemicos de la zona del Bosque Húmedo, donde tambien hay otros arboles";
    this.AdescripcionLinea3= "cómo los coihues y lenguas. ";
    ...
    this.AtituloBoton1 = "Su madera";
    this.AdescripcionBoton1Linea1 = "Anteriormente fue utilizada cómo leña ";
    this.AdescripcionBoton1Linea2 = "por su resistencia y larga duracíon, ";
    this.AdescripcionBoton1Linea3 = "actualmente se utiliza para producir ";
    this.AdescripcionBoton1Linea4 = "manofacturas cómo muebles.";
    this.AdescripcionBoton1Linea5 = "";
    this.AdescripcionBoton1Linea6 = "";
    this.AimgBoton2 = loadImage("img/AimgBoton2.jpg");
    this.AtituloBoton2 = "Decoración";
    this.AdescripcionBoton2Linea1 = "Por su forma y cómo cambia el color de";
    this.AdescripcionBoton2Linea2 = "sus hojas a lo largo del año es ";
    this.AdescripcionBoton2Linea3 = "recurrentemente utilizado como decoración";
    this.AdescripcionBoton2Linea4 = "para grandes jardines. ";
    ...
    this.Btitulo = "Ciprés";
    this.BdescripcionLinea1= "Es una especie de árbol que está por algunas regiones de america del norte ";
    this.BdescripcionLinea2= "y del sur y se cultiva en Africa y Nueva Zelanda. Pertenece al género ";
    this.BdescripcionLinea3= "Cupressus. En Argentina se encuentra en el Bosque de Transición, ubicado ";
    this.BdescripcionLinea4= "entre el Bosque Humedo y la Estepa.";
    ...
    this.BdescripcionBoton1Linea3 = "en las piernas, ya que posee efectos sobre";
    this.BdescripcionBoton1Linea4 = "la circulación sanguínea.";
    this.BdescripcionBoton1Linea5 = "";
    this.BdescripcionBoton1Linea6 = "";
    this.BimgBoton2 = loadImage("img/BimgBoton2.jpg");
    this.BtituloBoton2 = "Decoración";
    ...
    this.Ctitulo = "Neneo";
    this.CdescripcionLinea1= "Presente en la zona de Estepa, ";
    ...
    this.CtituloBoton1 = "Madera";
    this.CdescripcionBoton1Linea1 = "Antiguamente se utilizaba como combustible,";
    this.CdescripcionBoton1Linea2 = "actualmente su madera es utilizada para la ";
    this.CdescripcionBoton1Linea3 = "confeccion de manofacturas debido a su ";
    this.CdescripcionBoton1Linea4 = "elevada resistencia.";
    this.CdescripcionBoton1Linea5 = "";
    this.CdescripcionBoton1Linea6 = "";
    this.CimgBoton2 = loadImage("img/CimgBoton2.jpg");
    this.CtituloBoton2 = "Medicinal";
    this.CdescripcionBoton2Linea1 = "Es una de las plantas mas estudiadas ";
    this.CdescripcionBoton2Linea2 = "medicinalmente, usado comúnmente para el control";
    this.CdescripcionBoton2Linea3 = "de la diabetes y cálculos renales.";
