class Contenedores {
  ...
  completarVariables(){
    ...
    this.BdescripcionBoton1Linea1 = "Se usa como depurativo hepático. Actúa";
    ...
    this.BdescripcionBoton2Linea1 = "Se lo utiliza como digestivo, en el ";
    this.BdescripcionBoton2Linea2 = "tratamiento de la Hepatitis, y para";
    this.BdescripcionBoton2Linea3 = "contrarrestar intoxicaciones en general";
    ...
    this.CdescripcionBoton1Linea1 = "Se utiliza comúnmente en cataplasmas";
    this.CdescripcionBoton1Linea2 = " para aliviar inflamaciones externas, ";
    this.CdescripcionBoton1Linea3 = "fracturas dislocaciones y dolores reumáticos";
